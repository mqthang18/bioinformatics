    ...
    <div class="accordion">
        ...
        <div class="card mb-2">
            ...
            <div id="step1" data-bs-parent="#accordion" class="collapse p-4">
                ...
                <center>
                    <img class="table" src="./assets/img/InVEST/HQ_stressor_info.jpg" alt="HQ_stressor_info">
                </center>
                ...
                <center>
                    <img class="map" src="./assets/img/InVEST/HQ_sensitivity.jpg" alt="HQ_sensitivity">
                </center>
            </div>
        </div>
        ...
        <div class="card mb-2">
            ...
            <div id="step2" data-bs-parent="#accordion" class="collapse p-4">
                <center>
                    <img src="./assets/img/InVEST/HQ_structrure.jpg" alt="folder_structure" class="map">
                </center>
            </div>
        </div>
        ...
        <div class="card mb-2">
            <div class="card-header">
                <a href="#step3" class="btn" data-bs-toggle="collapse">Bước 3. Mở chương trình Habitat Quality</a>
            </div>
            <div id="step3" data-bs-parent="#accordion" class="collapse p-4">
                <center>
                    <img src="./assets/img/InVEST/HQopen.png" alt="HQopen" class="map">
                </center>
            </div>
        </div>
        ...
        <div class="card mb-2">
            ...
            <div id="step4" data-bs-parent="#accordion" class="collapse p-4">
                <center>
                    <img src="./assets/img/InVEST/HQinterface.jpg" alt="HQ_interface" class="map">
                </center>
            </div>
        </div>
        ...
        <div class="card mb-2">
            ...
            <div id="step5" data-bs-parent="#accordion" class="collapse p-4">
                <center>
                    <img src="./assets/img/InVEST/HRAprocess.png" alt="HRAprocess" class="map">
                </center>
            </div>
        </div>
        ...
        <div class="card mb-2">
            ...
            <div id="step7" data-bs-parent="#accordion" class="collapse p-4">
                <center>
                    <img src="./assets/img/InVEST/HQdeg.png" alt="HQdeg" class="map">
                </center>
                <center>
                    <img class="map" src="./assets/img/InVEST/HQ_score.png" alt="HQ_score">
                </center>
            </div>
        </div>
